...
public class Belokan {
    public static void main(String[] args) {
        ...
        if (a.equals("Selatan")  && b.equals("Utara") && c.equals("Timur")){
            ...
            System.out.println("Ya");
        }else if (a.equals("Timur") && b.equals("Barat") && c.equals("Selatan")){
            System.out.println("Ya");
        }else if (a.equals("Selatan") && b.equals("Barat") && c.equals("Timur")){
            System.out.println("Ya");
        }else if (a.equals("Barat") && b.equals("Utara") && c.equals("Sealtan")){
            System.out.println("Ya");
        }else if (a.equals("Utara") && b.equals("Timur") && c.equals("Barat")){
            System.out.println("Ya");
        }else if (a.equals("Timur") && b.equals("Selatan") && c.equals("Utara")){
            System.out.println("Ya");
        }else{
